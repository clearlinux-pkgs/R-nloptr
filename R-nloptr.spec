...
Version  : 2.2.1
Release  : 92
URL      : https://ftp.osuosl.org/pub/cran/src/contrib/nloptr_2.2.1.tar.gz
Source0  : https://ftp.osuosl.org/pub/cran/src/contrib/nloptr_2.2.1.tar.gz
...
%package dev
Summary: dev components for the R-nloptr package.
Group: Development
Requires: R-nloptr-lib = %{version}-%{release}
Provides: R-nloptr-devel = %{version}-%{release}
Requires: R-nloptr = %{version}-%{release}

%description dev
dev components for the R-nloptr package.
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1742441659
...
/usr/lib64/R/library/nloptr/tinytest/test-Rosenbrock-banana.R
